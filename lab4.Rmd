...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_rw134>
...
```{r}
example <- "This is an example of a string in r."
print(example)
```
...
# This code chunk option runs the cell but doesn't include it in the knit.

output_is_hidden <- TRUE
print(output_is_hidden)
...
output_is_hidden <- "This is a string"
